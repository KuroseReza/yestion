/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 30df94aa8f684c30cd1f7bced67be062)
...
declare namespace Cloudflare {
	interface Env {
		...
		R2: R2Bucket;
		DB: D1Database;
		R2_BUCKET: "yestion-media";
		R2_ACCOUNT_ID: "aa3e76f64cf65d52920c66b3d847d1b0";
		INIT_ADMIN_EMAIL: "admin@yestion.local";
